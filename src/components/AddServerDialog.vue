        ...
        <template #body>
            <form id="server-form" @submit.prevent="handleSave" class="servers__dialog-form">
                <div class="servers__dialog-grid">
                    <div class="servers__dialog-group">
                        <div class="servers__dialog-grid-item">
                            ...
                            <input id="name" name="name" v-model="formData.name" placeholder="Название" type="text" />
                        </div>
                        <div class="servers__dialog-grid-item">
                            <label for="country">Страна</label>
                            <input id="country" name="country" v-model="formData.country" placeholder="Страна"
                                type="text" />
                        </div>
                        <div class="servers__dialog-grid-item">
                            <label for="code">Код</label>
                            <input id="code" name="code" v-model="formData.code" placeholder="Код" type="text" />
                        </div>
                        <div class="servers__dialog-grid-item">
                        ...
                        <div class="servers__dialog-grid-item">
                            ...
                            <input id="public_key" name="public_key" v-model="formData.public_key"
                                placeholder="Публичный ключ" type="text" />
                        </div>
                    ...
                    <div class="servers__dialog-group">
                        <div class="servers__dialog-grid-item">
                            <label for="port_panel">Порт панели</label>
                            <input id="port_panel" name="port_panel" v-model="formData.port_panel"
                                placeholder="Порт панели" type="text" />
                        </div>
                        <div class="servers__dialog-grid-item">
                            <label for="uri_path">URL путь к панели</label>
                            <input id="uri_path" name="uri_path" v-model="formData.uri_path"
                                placeholder="URL путь к панели" type="text" />
                        </div>
                        <div class="servers__dialog-grid-item">
                            <label for="password">Пароль к панели</label>
                            <input id="password" name="password" v-model="formData.password"
                                placeholder="Пароль к панели" type="text" />
                        </div>
                        <div class="servers__dialog-grid-item">
                            <label for="port_key">Порт inbound</label>
                            <input id="port_key" name="port_key" v-model="formData.port_key" placeholder="Порт inbound"
                                type="text" />
                        </div>
                        <div class="servers__dialog-grid-item">
                            <label for="short_id">Короткий ID</label>
                            <input id="short_id" name="short_id" v-model="formData.short_id" placeholder="Короткий ID"
                                type="text" />
                        </div>
                        <div class="servers__dialog-grid-item">
                            <label for="weight">Вес</label>
                            <input id="weight" name="weight" v-model.number="formData.weight" placeholder="Вес"
                ...
                <div class="servers__dialog-grid-item">
                    ...
                    <input id="description" name="description" v-model="formData.description" placeholder="Описание"
                        type="text" />
                </div>
                <div class="servers__dialog-grid-item">
                    <label for="info">Инфо (не видно пользователям)</label>
                    <input id="info" name="info" v-model="formData.info" placeholder="Инфо" type="text" />
                </div>
            </form>
        </template>
